...
continuation_groups="$(read_stat "$normal" system.cpu.dvrVIRContinuationPCGroups)"
continuation_grouped_lanes="$(read_stat "$normal" system.cpu.dvrVIRContinuationGroupedLanes)"
continuation_max_width="$(read_stat "$normal" system.cpu.dvrVIRContinuationMaxGroupWidth)"
...
require_nonzero vir_continuation_pc_groups "$continuation_groups"
require_nonzero vir_continuation_grouped_lanes "$continuation_grouped_lanes"
